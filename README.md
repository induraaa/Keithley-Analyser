...
py -m PyInstaller --noconfirm --clean --onefile --windowed --name "WaferMapViewer" --icon "app_icon.ico" --add-data "app_icon.ico;." --collect-data PySide6 --hidden-import openpyxl --hidden-import lxml mapping_tool.py
## ✨ Features
